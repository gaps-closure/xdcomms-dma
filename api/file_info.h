...
#define XARBITOR_SEND_SCRIPT_FIXED_ARGS  " -g 1124 -p /home/closure/XA-FILES/xarbitor/api/test_apps/etc/pki_auth -c /home/closure/XA-FILES/xarbitor/api/test_apps/etc/credential/xarbitor_temporary_1.0.0.0_client.p12 --password=password"
